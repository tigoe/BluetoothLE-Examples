...
var DEVICE = 'Bean';
var beanServiceUUID = 'A495FF20-C5B1-4B44-B512-1370F02D74DE';
var beanCharacteristicUUID = 'A495FF21-C5B1-4B44-B512-1370F02D74DE';
...
sendData: function(data) { // data received from Bean
	...
	var data = new Buffer([r, g, b]);
	
	onSuccess = function(){
		alert("data written: "+r+", "+g+", "+b);
	}
	
	ble.write(deviceId, beanServiceUUID, beanCharacteristicUUID, data, onSuccess, app.onError);
