/*
  Simplified Humidity Sensor example

  This example reads the Humidity sensor on a sensorTag.
...
function handleTag(tag) {
	...
	*/
	function enableSensors() {		// attempt to enable the sensors
		...
		tagRecord.rhSensor = {sensor: 'humidity sensor'};
		// set its period:
		tag.setHumidityPeriod(100);
	...
	tag.on('humidityChange', readHumidity);
