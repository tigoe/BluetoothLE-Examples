/*
  Simplified gyroscope example

  This example reads the gyroscope on a sensorTag.
...
function handleTag(tag) {
	...
	gyroscope data here, you could duplicate this pattern
	...
	*/
	...
	// set a listener for when the gyroscope changes:
